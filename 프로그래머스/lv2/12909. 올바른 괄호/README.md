...
---
        stack을 사용했다. '('이면 스택에 넣고 ')'이면 스택에서 하나 뺀다. 빼야하는데 스택이 비어있으면 false를 리턴한다.
        for문을 다 돌렸는데 stack이 비어있으면 true를 리턴한다.
        stack클래스를 사용하는데 아직 익숙하지 않아 살짝 당황하긴 했지만 다시 개념을 찾아보며 공부했다.
